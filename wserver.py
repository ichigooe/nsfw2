   ...
   <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        ...
        <a href="https://t.me/jkxmirrorr"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>Jkxbot <a href='https://www.github.com'>@GitHub</a> By <a href='https://github.com'>Botx</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>Jkxbot</h3>", content_type="text/html")
            return response
