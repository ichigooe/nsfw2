    ...
    with download_dict_lock:
        ...
        for index, download in enumerate(list(download_dict.values())[START:], start=1):
            ...
            if download.status() not in [
                ...
                msg += f"\n<b>Seed:</b> {download.speed()} | <b>ETA:</b> {download.eta()}"
                try:
                    msg += f"\n<b>⚡️ Speed::</b> {download.aria_download().num_seeders}" \
                ...
                try:
                    ...
                    pass
                msg += f'\n<b>👨🏽‍💻 By:</b> ️<code>{download.message.from_user.first_name}</code>️(<code>{download.message.from_user.id}</code>)'
